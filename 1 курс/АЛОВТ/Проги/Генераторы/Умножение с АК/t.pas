program main;
//Умножение с автоматической коррекцией 1 способ
...
function left(a:ssstring):ssstring;
var i:integer;
begin
	for i:=1 to m*2-1 do
	begin
...
function sdv(a:ssstring; i:integer):ssstring;//сдвиг
begin
	for i:=1 to i do
	begin
		a:=left(a);
